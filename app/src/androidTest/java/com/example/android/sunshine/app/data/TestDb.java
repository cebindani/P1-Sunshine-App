...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        Cursor weatherCursor = database.query(WeatherContract.WeatherEntry.TABLE_NAME, null, null, null, null, null, null);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Cursor and ContentValues didn't match!", weatherCursor, weatherValues);

        // Finally, close the cursor and database
        weatherCursor.close();
        weatherDbHelper.close();
        //TODO: Pq fechar o weatherDbHelper e não o database ??
    }
    ...
    public long insertLocation() {
        ...
        Log.d("TEST", "testLocationTable: " + db.toString());
        ...
        // Move the cursor to a valid database row
        cursor.moveToFirst();
        Log.d("TEST", "testLocationTable Content: " + DatabaseUtils.dumpCursorToString(cursor));

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Cursor and ContentValues didn't match!", cursor, contentValues);
